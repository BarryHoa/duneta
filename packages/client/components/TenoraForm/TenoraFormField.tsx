...
export type TenoraFormFieldProps = Omit<TextFieldProps, 'children'> & {
  label: ReactNode; children: ReactNode; description?: ReactNode; error?: string; labelClassName?: string;
};

export function TenoraFormField({ label, children, description, error, isInvalid, className, labelClassName = '', ...props }: TenoraFormFieldProps) {
