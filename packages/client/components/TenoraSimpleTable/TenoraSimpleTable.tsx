import type { TenoraSimpleTableColumn, TenoraSimpleTableProps } from './types';

export type { TenoraSimpleTableColumn, TenoraSimpleTableProps };

export function TenoraSimpleTable<T>({
  data,
  columns,
  getRowKey,
  emptyState = 'No data yet.',
  className = '',
}: TenoraSimpleTableProps<T>) {
  return (
    <div
