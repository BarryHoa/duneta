import type { TenoraDataTableToolbarGroupConfig } from '../types/toolbar';
import type { TenoraDataTableColumnMeta } from '../types/column-meta';
...
export function resolveGroupableColumnIds(
  ...
  groupConfig?: TenoraDataTableToolbarGroupConfig | null,
): string[] | null {
