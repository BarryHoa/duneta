...
export type IbaseFormRadioOption = { value: string; label: ReactNode; isDisabled?: boolean };
export type IbaseFormRadioFieldProps = Omit<RadioGroupProps, 'children' | 'label'> & { label: ReactNode; options: IbaseFormRadioOption[]; description?: ReactNode; error?: string; layout?: 'horizontal' | 'vertical' };

export function IbaseFormRadioField({ label, options, description, error, layout = 'vertical', isInvalid, ...props }: IbaseFormRadioFieldProps) {
